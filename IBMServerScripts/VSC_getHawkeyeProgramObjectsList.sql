...
VSC00AFN83: begin
   ...
   */
    ...
    set cmdstring = 'DSPPGMOBJ PGM(QAUOOPT) OUTPUT(*OUTFILE) OUTFILE('||trim(user)||'/VSC_T$DPO) OUTMBR(*FIRST *REPLACE)';
...
;select * from table(ILEDITOR.VSC_getHawkeyeProgramObjectsList(IN_LIB=> 'WFIOBJ',IN_OBJ=>'PRP03ZRG',IN_RUN_ME_CODE => 'Y')) x order by MBLIB ,MBNAME
