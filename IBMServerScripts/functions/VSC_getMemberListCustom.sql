...
/* T09 */;select * from table ( VSC_GETMEMBERLISTCUSTOM(IN_MBR => '#STR0000000', IN_LIB => 'WFIQUAL' ,IN_SRCF=>'Q*') )
...
/* T39 */;select * from table ( VSC_GETMEMBERLISTCUSTOM(IN_LIB => 'WFIQUAL',IN_SRCF => 'QRPGSRC'  ,IN_MBR => '#STR2030600' , IN_DEBUG_PARMS => '1' ))
