...
## * Aldon tasks
  ...
  3. To link this filter to an Aldon project, add this pattern in the member input, `#PCR#####VV` or `STR#######`, where ##### is the PCr number and VV is the PCR version.  Alternatively, you can also tag # symbol to the front of any 10 character string and have that sting be connected to an Aldon task filter ID. 
