...
export const fr: Locale = {
  ...
  'splfBrowser.addUserSpooledFileFilter.prompt': `Utilisateur pour afficher les fichiers spoules`,
  'splfBrowser.deleteUserSpooledFileFilter.placeHolder': `Sélectionnez le nom du filtre à supprimer`,
  'splfBrowser.deleteSpooledFile.warningMessage': `Voulez-vous vraiment supprimer le fichier spoule {0}?`,
  'splfBrowser.deleteSpooledFile.infoMessage': `Supprimé {0}.`,
  'splfBrowser.deleteSpooledFile.errorMessage': `Erreur lors de la suppression du fichier spoule de l'utilisateur! {0}.`,
  'splfBrowser.deleteSpooledFile.cancelled': `Suppression annulée.`,
  'splfBrowser.deleteNamedSpooledFiles.warningMessage': `Êtes-vous sûr de vouloir supprimer TOUS les fichiers spoule nommés {0} pour l'utilisateur {1}?`,
  'splfBrowser.deleteNamedSpooledFiles.infoMessage': `Suppression de {0}fichiers spoules`,
  'splfBrowser.deleteNamedSpooledFiles.errorMessage': `Erreur lors de la suppression des fichiers spoule de l'utilisateur! {0}.`,
  'splfBrowser.deleteNamedSpooledFiles.cancelled': `Suppression annulée.`,
  'splfBrowser.deleteUserSpooledFiles.warningMessage': `Êtes-vous sûr de vouloir supprimer TOUS les fichiers spoule pour l'utilisateur {0}?`,
  'splfBrowser.deleteUserSpooledFiles.infoMessage': `Suppression de {0}fichiers spoules.`,
  'splfBrowser.deleteUserSpooledFiles.errorMessage': `Erreur lors de la suppression des fichiers spoule de l'utilisateur! {0}.`,
  'splfBrowser.deleteUserSpooledFiles.cancelled': `Suppression annulée.`,
  'splfBrowser.moveSpooledFile.prompt': `Nom de la nouvelle OUTQ`,
  'splfBrowser.moveSpooledFile.errorMessage': `Erreur lors du déplacement du fichier spoule! {0}`,
  'splfBrowser.searchSpooledFiles.promptUserName': `Entrez l'utilisateur à rechercher`,
  'splfBrowser.searchSpooledFiles.promptUserNameTitle': `Rechercher les fichiers spoule de l'utilisateur`,
  'splfBrowser.searchSpooledFiles.promptSplfName': `Entrez le nom du fichier spoule sur lequel effectuer la recherche`,
  'splfBrowser.searchSpooledFiles.promptSplfNameTitle': `Rechercher dans le fichier spoule nommé`,
  'splfBrowser.searchSpooledFiles.promptsearchTerm': `Rechercher dans les fichiers spoule nommés {0}`,
  'splfBrowser.searchSpooledFiles.progressTitle': `Recherche active`,
  'splfBrowser.searchSpooledFiles.progressMessage0': `'{0}' dans {1}, {2} fichiers spoules.`,
  'splfBrowser.searchSpooledFiles.progressMessage1': `'{0}' dans {1} fichiers spoules.`,
  'splfBrowser.searchSpooledFiles.progressMessage2': `Cela prend du temps car il y a {0} fichiers spoules. Recherche '{1}' dans {2} encore.`,
  'splfBrowser.searchSpooledFiles.progressMessage3': `Qu'y a-t-il de si spécial à propos de '{0}' de toute façon?`,
  'splfBrowser.searchSpooledFiles.progressMessage4': `Recherche toujours '{0}' dans {1}...`,
  'splfBrowser.searchSpooledFiles.progressMessage5': `Waouh. Cela prend vraiment un certain temps. Espérons que vous obtiendrez le résultat que vous voulez.`,
  'splfBrowser.searchSpooledFiles.progressMessage6': `Comment se retrouve-t-on avec {0} fichiers spoules. Avez-vous déjà entendu parler de nettoyage?`,
  'splfBrowser.searchSpooledFiles.progressMessage7': `'{0}' dans {0}.`,
  'splfBrowser.searchSpooledFiles.infoMessage': `Aucun résultat trouvé pour la recherche de '{0}' dans {1}.`,
  'splfBrowser.searchSpooledFiles.errorMessage0': `Aucun fichier spoule à rechercher.`,
  'splfBrowser.searchSpooledFiles.errorMessage1': `Erreur lors de la recherche de fichiers spoules.`,
};