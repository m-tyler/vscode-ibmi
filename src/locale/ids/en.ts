...
export const en: Locale = {
  ...
  'splfBrowser.deleteNamedSpooledFiles.warningMessage': `Are you sure you want to delete ALL spooled files named {0} for user {1}, using filter {2} or All like named?`,
