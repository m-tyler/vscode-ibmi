...
// ProfilesView:
  ...
  'splfBrowser.downloadSpooledfile.error': `Error downloading Spoooled File! {0}`,
  'splfBrowser.downloadSpooledfile.errorCMD': `Download spooled file not allowed from command line`,
  ...
  'objectBrowser.HWKdisplayFileSetsUsed.prompt': `Enter LIBRARY/FILE to search for references. See the help for DSPFILSETU for selectable input values`,
  'objectBrowser.HWKdisplayFileSetsUsed.title': `Display File Set Where Used`,
  'objectBrowser.HWKdisplayFileSetsUsed.invalidForm': `Please enter value in form LIBRARY/FILE`,
  'objectBrowser.HWKdisplayFileSetsUsed.prompt2': `Select token to search results from DSPFILSETU`,
  'objectBrowser.HWKdisplayFileSetsUsed.notFound':`No results found searching for '{0}' using HAWKEYE/DSPFILSETU {1}.`,
  // 'objectBrowser.HWKdisplayFileSetsUsed.noMembers': `No members to search.`,
  'objectBrowser.HWKdisplayFileSetsUsed.errorMessage': `Error searching for file uses of: {0}`,
  'objectBrowser.HWKdisplayFileSetsUsed.progressMessage': `Starting process to find file sets used.`,
  'objectBrowser.HWKdisplayFileSetsUsed.searchMessage0': `Using Hawkeye Pathfinder's DSPFILSETU to search for file sets used`,
  'objectBrowser.HWKdisplayFileSetsUsed.searchMessage1': `Searching in '{1}' for uses of {0}.`,
  // 'objectBrowser.HWKdisplayFileSetsUsed.searchMessage2': `This is taking a while because there are {0} members. Searching '{1}' in {2} still.`,
  'objectBrowser.HWKdisplayFileSetsUsed.searchMessage3': `What's so special about '{0} in {1}' anyway?`,
  'objectBrowser.HWKdisplayFileSetsUsed.searchMessage4': `Still getting uses for {0}...`,
  'objectBrowser.HWKdisplayFileSetsUsed.searchMessage5': `While you wait, why not make some tea?`,
  'objectBrowser.HWKdisplayFileSetsUsed.searchMessage6': `Wow. This really is taking a while. Let's hope you get the result you want.`,
  'objectBrowser.HWKdisplayFileSetsUsed.searchMessage7': `Why was six afraid of seven?`,
  // 'objectBrowser.HWKdisplayFileSetsUsed.searchMessage8': `How does one end up with {0} members?`,
  'objectBrowser.HWKdisplayFileSetsUsed.searchMessage9': `Searching in '{0}' for uses of {1}.`,
